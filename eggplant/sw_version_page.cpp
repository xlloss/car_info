...
QString sw_version_sub_text[SW_VER_SUB_TEX_COL_NUM][SW_VER_SUB_TEX_ROW_NUM] = {
    {SWVER_SUB_TEX_ID00, SWVER_SUB_TEX_ID01, SWVER_SUB_TEX_ID02,
        SWVER_SUB_TEX_ID03, SWVER_SUB_TEX_ID04,

     SWVER_SUB_TEX_ID05, SWVER_SUB_TEX_ID06, SWVER_SUB_TEX_ID07,
        SWVER_SUB_TEX_ID08, SWVER_SUB_TEX_ID09},

    {SWVER_SUB_TEX_ID10, SWVER_SUB_TEX_ID11, SWVER_SUB_TEX_ID12,
        SWVER_SUB_TEX_ID13, SWVER_SUB_TEX_ID14,

     SWVER_SUB_TEX_ID15, SWVER_SUB_TEX_ID16, SWVER_SUB_TEX_ID17,
        SWVER_SUB_TEX_ID18, SWVER_SUB_TEX_ID19},
};


QString sw_version_sub_text_msg[SW_VER_SUB_TEX_MSG_NUM] =
    {SATIN_MSG_SUB_TEX_MSG_ID0, SATIN_MSG_SUB_TEX_MSG_ID1};
...
SwVersion_Page::SwVersion_Page(QWidget *parent) : Frame_Page(parent)
{
    ...
    for (i = 0; i < SW_VER_SUB_TEX_COL_NUM; i++) {
        ...
        for (k = 0; k < SW_VER_SUB_TEX_ROW_NUM; k++) {
            ...
            show_sub_item[i][k]->setGeometry(sw_version_sub_text_xy[j] +
                sw_version_sub_text_x_offset[i],
                    sw_version_sub_text_xy[j + 1],
                    SWVER_SUB_TEX_W, SWVER_SUB_TEX_H);
            ...
            show_sub_item[i][k]->setGeometry(sw_version_sub_text_xy[j] +
                sw_version_sub_text_msg_off[i],
                sw_version_sub_text_xy[j + 1],
                SWVER_SUB_TEX_W + 50, SWVER_SUB_TEX_H);
